...
function Navbar() {
    ...
    {/* New Navbar Items */}
                            ...
                            <NavItem>
                                <NavLinks to='/join-mentor' onClick={closeMobileMenu}>
                                    Join as Mentor
                                </NavLinks>
                            </NavItem>

                            <NavItem>
                                <NavLinks to='/join-expert' onClick={closeMobileMenu}>
                                    Join as Expert
                                </NavLinks>
                            </NavItem>
                        ...
                        <NavItemBtn >
                            {button ? (
                                <NavBtnLink to='/About'>
                                    <Button primary>Company About</Button>
                                </NavBtnLink>
                            ) : (
                                <NavBtnLink to='/About'>
                                    <Button onClick={closeMobileMenu} fontBig primary>Company About</Button>
                                </NavBtnLink>
                            )}
